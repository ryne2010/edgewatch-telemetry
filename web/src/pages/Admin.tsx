...
import { api, type DriftEventOut, type ExportBatchOut, type IngestionBatchOut, type NotificationEventOut } from '../api'
...
type AdminTab = 'ingestions' | 'drift' | 'notifications' | 'exports'
...
export function AdminPage() {
  ...
  const active = tab === 'ingestions' ? ingestionsQ : tab === 'drift' ? driftQ : tab === 'notifications' ? notificationsQ : exportsQ

  return (
    <Page
      title="Admin"
      description="Audit trails for ingestion, contract drift, notifications, and exports."
      actions={
